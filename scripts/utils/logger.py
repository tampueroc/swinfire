...
class Logger:
    ...
    """
    @staticmethod
    def get_tensorboard_logger(save_dir, name="default", log_graph=False, default_hp_metric=False):
        """
        ...
        """
        return TensorBoardLogger(save_dir=save_dir, name=name, log_graph=log_graph, default_hp_metric=default_hp_metric)
